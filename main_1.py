...
Computing_unigrams=["health","computational","human","computer", "interaction", "informatics","cyber","security","game","design",
                    "web","development", "search", "machine", "learning","technology","digital","graphic","game","language","software","coding","programming", "cryptography","data","science", "mining","computing","artificial","intelligence","database"]
Computing_unigrams=[ps.stem(w1) for w1 in Computing_unigrams]
...
Computing_bigrams=["data science","health information","health informatics", "bioinformatics", "machine learning", "natural language", "language processing", "information management","information retrieval","human computer", "computer interaction", "information security",
                 "information privacy","information technology","information policy","web development","cyber security","computational social",
                 "computational science", "game design","game development"]
Computing_bigrams_Dict=dict((term,0) for term in Computing_bigrams)

Library_unigrams=["library","archive","privacy","information","privacy","policy","security","digital", "curation", "collections", "cataloging","society","media","management","art","law",
                  "records","public","librarianship", "resources","digitization", "preservation", "knowledge","services", "administration","communities","communication","organization","collections","culture", "behavior","museums"]

Library_unigrams=[ps.stem(w2) for w2 in Library_unigrams]
...
Library_bigrams=["collection management","information services","information organization","digital curation","digital preservation","digital information","Information Quality","Digital Cultures",
                 "Information Age","Digital World",""]  # ############# Fill this after consulting library professors
...
save_img(sorted_dict_1,"Computing_unigram_histogram.png")
save_img(sorted_dict_2,"Library_unigram_histogram.png")
